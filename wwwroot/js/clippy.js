...
clippy.Agent.prototype = {
    ...
    saySomething: function (dagsnamn, manadsnamn) {
        this.play('Idle1_1');
        this.speak("Idag är det " + dagsnamn + "!");
        if (dagsnamn === "måndag") {
            this.speak("Fyyyyy faaan, vad jag hatar måndagar!!!");
        }
        if (dagsnamn === "tisdag") {
        ...
        if (dagsnamn === "torsdag") {
            this.speak("På torsdagar är jag redlöst berusad,");
            this.speak("och har en jäääävla baksmälla.");
        }
        if (dagsnamn === "fredag") {
            this.speak("Vad skönt att det är fredag idag!");
            this.speak("Ordning och reda, löning på fredag!!!");
        }
        if (dagsnamn === "lördag") {
            this.speak("Jag älskar lördagar! På lördagar latar jag mig!");
        }
        if (dagsnamn === "söndag")
            this.speak("På söndagar brukar jag sova till klockan 12:00");

        if (spring.indexOf(manadsnamn) !== -1) {
            this.speak("Vad underbart att vintern är över nu!!!");
        }
        if (summer.indexOf(manadsnamn) !== -1) {
            this.speak("Vad härligt att det är sommar nu!!!");
        }
        if (autumn.indexOf(manadsnamn) !== -1) {
            this.speak("Vad synd att sommaren är slut!!!");
        }
        if (winter.indexOf(manadsnamn) !== -1) {
            this.speak("Vad trist och tråkigt att det är vinter nu!!!");
        }
    },
